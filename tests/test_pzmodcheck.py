...
Run: python tests/test_pzmodcheck.py
...
from pzmodcheck.builds import select_branch, version_tuple  # noqa: E402
from pzmodcheck.logs import setup_logging  # noqa: E402
from pzmodcheck import store  # noqa: E402
from pzmodcheck import selection as sel  # noqa: E402
from pzmodcheck.pipeline import ScanOptions, run_scan  # noqa: E402
from pzmodcheck.report import render_html, to_dict  # noqa: E402
from pzmodcheck.models import Finding, Severity  # noqa: E402
from pzmodcheck.posters import find_poster, pillow_available, poster_blocks  # noqa: E402
from pzmodcheck import steamsdk  # noqa: E402
from pzmodcheck.scripts import parse_script_text  # noqa: E402
...
def test_cli_routing(tmp: Path) -> None:
    ...
    from pzmodcheck import cli
    import pzmodcheck.tui as tuimod
...
def test_steam_output_capture() -> None:
    ...
    from pzmodcheck.steamsdk import steam_output_to_log
    ...
    logger = logging.getLogger("pzmodcheck.steamsdk")
    handler = Catcher()
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        for source in sorted(Path("pzmodcheck").glob("*.py")) + [Path("README.md")]:
